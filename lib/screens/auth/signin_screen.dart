...
class _SigninScreenState extends State<SigninScreen> {
  ...
  final List<String> _roles = ['Patient', 'Caregiver', 'Doctor'];
      ...
      try {
        ...
        if (mounted) {
          ...
          if (res.user != null) {
            ...
            print('Sign in successful. User ID: $userId. Checking role: $_selectedRole');
            ...
            print('isValidRole returned: $isValidRole');
